...
public class ChooseColor extends javax.swing.JDialog {
    ...
    public ChooseColor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        tc = (TileCreater) parent;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        tc.selectColor(this.jColorChooser1.getColor());
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChooseColor dialog = new ChooseColor(new javax.swing.JFrame(), true);
